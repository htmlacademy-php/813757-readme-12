                    ...
                    <header class="post__header post__author">
                        <a class="post__author-link" href="profile.php?author_id=<?= htmlspecialchars($post['author_id']) ?>" title="Автор">
                            <div class="post__avatar-wrapper">
                                <img class="post__author-avatar" src="uploads/<?= htmlspecialchars(!empty($post['avatar']) ? $post['avatar'] : "icon-input-user.svg") ?>" alt="Аватар пользователя" width="60" height="60">
                            </div>
