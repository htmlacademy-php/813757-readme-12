        ...
        <div class="adding-post container">
          <div class="adding-post__tabs-wrapper tabs">
            ...
            <div class="adding-post__tab-content">
              <section class="adding-post__<?= $form_type; ?> tabs__content tabs__content--active">
                <h2 class="visually-hidden">Форма добавления <?= $form_type; ?></h2>
                <form class="adding-post__form form" action="add.php?form-type=<?= $form_type; ?>" method="post" <?= ($form_type === $types[2]) ? 'enctype="multipart/form-data"' : ""; ?>>
                      ...
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        <?php if ($form_type === $types[2]): ?>
                            ...
                            <div class="form__input-section <?= isset($errors['photo-url']) ? 'form__input-section--error' : '' ?>">
                                ...
                                <input class="visually-hidden" id="" type="text" name="photo" value="photo" title="">
                            </div>
                    ...
                    <div class="form__invalid-block">
                      ...
                      <ul class="form__invalid-list">
                        <?php foreach($errors as $key => $error): ?>
                          <li class="form__invalid-item"><?= getTranslate($key).': '.$error; ?></li>
                        <?php endforeach; ?>
                      </ul>
                    </div>
                    <?php endif; ?>
