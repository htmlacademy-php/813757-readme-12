      ...
      <div class="profile__user user container">
        <div class="profile__user-info user__info">
          <div class="profile__avatar user__avatar">
            <img class="profile__picture user__picture" src="uploads/<?= !empty($authorData['avatar']) ? htmlspecialchars($authorData['avatar']) : "icon-input-user.svg" ?>" alt="Аватар пользователя">
          </div>
            ...
            <article class="profile__post post post-<?= htmlspecialchars($authorPost['icon_class']) ?>">
              ...
              <div class="post__main">
                ...
                <div class="post-photo__image-wrapper">
                    <img src="uploads/<?= htmlspecialchars($authorPost['image']) ?>" alt="Фото от пользователя" width="760" height="507">
                </div>
