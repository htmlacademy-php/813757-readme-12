          ...
          <form class="authorization__form form" action="#" method="post">
            <div class="authorization__input-wrapper form__input-wrapper">
              <div class="form__input-section <?= isset($errors['login']) ? 'form__input-section--error' : '' ?>">
                <input class="authorization__input authorization__input--login form__input" type="text" name="login" value="<?= $_POST['login'] ?? '' ?>" placeholder="Логин">
            ...
            <div class="authorization__input-wrapper form__input-wrapper">
              <div class="form__input-section <?= isset($errors['password']) ? 'form__input-section--error' : '' ?>">
                <input class="authorization__input authorization__input--password form__input" type="password" name="password" value="<?= $_POST['password'] ?? '' ?>" placeholder="Пароль">
